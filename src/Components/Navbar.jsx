...
const Navbar = () => {
    ...
    const links = <>
        <NavLink onClick={() => setToggle(false)} className='py-1' to='/'>Home</NavLink>
        <NavLink onClick={() => setToggle(false)} className='py-1' to='/all-artifacts'>All Artifacts</NavLink>
        <NavLink onClick={() => setToggle(false)} className='py-1' to='/about'>About </NavLink>
        <NavLink onClick={() => setToggle(false)} className='py-1' to='/contact'>Contact</NavLink>
        {
            user ? <div></div>
                : ""
        }
    ...
    return (
        <div className='container border-base-300  mx-auto py-5 flex items-center justify-between  px-4 md:px-0 '>
